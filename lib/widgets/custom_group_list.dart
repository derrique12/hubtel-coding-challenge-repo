...
///
@immutable
class CustomGroupedListView<T, E> extends StatefulWidget {
  ...
  /// Used to create spaces between groups
  final Widget? groupSeparatorBuilder;
  ...
  /// Creates a [CustomGroupedListView]
  ...
  @override
  State<StatefulWidget> createState() => _CustomGroupedListViewState<T, E>();
}

class _CustomGroupedListViewState<T, E>
    extends State<CustomGroupedListView<T, E>> {
          ...
          itemBuilder: (context, index) {
            ...
            if (index == hiddenIndex) {
              return Opacity(
                ...
                child: _buildHeader(_sortedElements[actualIndex]),
              );
            }
              ...
              if (prev != curr) {
                return Column(
                  ...
                  children: [
                    ...
                    _buildHeader(_sortedElements[actualIndex]),
                  ],
                );
              }
